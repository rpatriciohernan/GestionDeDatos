...
namespace UberFrba.Abm_Cliente
{
    class RepositorioCliente : Repositorio<Cliente>
    {
        ...
        {
            Cliente cliente = new Cliente(dr[0].ToString(), dr[1].ToString(), Convert.ToInt64(dr[2]), dr[3].ToString(), dr[4].ToString(), dr[5].ToString(), Convert.ToString(dr[6]), dr[7].ToString(), Convert.ToDateTime(dr[8]), dr[9].ToString());
            return cliente;
        }
        #endregion
